...
videosInfo.forEach(video => {
    ...
    videoDiv.innerHTML = `
    <div class="">
    <figure><img class="rounded-lg w-92 h-44 object-cover" src=${video.thumbnail} alt="Shoes" />
    </figure>
    <div class=" relative -top-10 -left-3 flex justify-end">
        <span class="text-white text-xs px-2 py-[7px]  rounded-md bg-[#171717]">3hrs 5 min ago</span>
    </div>
</div>
<div class="flex justify-between items-start gap-3 -mt-3">
    <div class="avatar">
        <div class="w-12 rounded-full">
            <img src="https://i.ibb.co/YZN9rQZ/tina.jpg" />
        </div>
    </div>
    <div class="space-y-1">
        <h1 class="text-base font-bold">Building a Winning UX Strategy Using the Kano Model</h1>
        <div class="flex justify-start gap-2 ">
            <h3 class="text-sm font-normal">Awlad Hossain</h3><span><svg
